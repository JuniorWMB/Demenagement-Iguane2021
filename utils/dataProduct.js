...
export let chambre = [
  ...
  { name: "Chaise de bureau", volume: 0.31, picture: chaiseDeBureau },
  { name: "Clic-clac", volume: 1.85, picture: "" },
  { name: "Commode", volume: 0.31, picture: "" },
  { name: "etagère - Bibliothèque", volume: 0.51, picture: etageres },
  { name: "Lampe sur pied", volume: 0.14, picture: lampeSurPied },
  { name: "Malle de rangement", volume: 0.21, picture: bancDeRangement },
...
export let cuisine = [
  { name: "Bahut", volume: 0.79, picture: "" },
  ...
  { name: "Hotte", volume: 0.3, picture: "" },
  { name: "Lave vaisselle", volume: 0.31, picture: laveVaisselle },
  { name: "Plante artificielle", volume: 0.09, picture: "" },
  { name: "Poubelle de cuisine", volume: 0.06, picture: "" },
...
export let salleDeBain = [
  { name: "Baignoire bébé", volume: 0.13, picture: "" },
  { name: "Colonne salle de bain", volume: 0.16, picture: "" },
  { name: "Meuble lavabo", volume: 0.34, picture: "" },
  { name: "Miroir rangement", volume: 0.05, picture: "" },
  { name: "Panière à linge", volume: 0.12, picture: "" },
];
export let salon = [
  { name: "Bibliothèque", volume: 0.78, picture: bibliotheque },
  { name: "Billard - 300 kgs", volume: 2.39, picture: "" },
  ...
  { name: "Table gigogne", volume: 0.12, picture: "" },
  { name: "Télévision 32 pouces", volume: 0.03, picture: tv },
  { name: "Télévision grand ecran", volume: 0.13, picture: tvGrand },
  { name: "Vaisselier", volume: 1.27, picture: "" },
];
